  ...
  return (
    <header className="fixed top-0 left-0 z-50 w-full border border-red-400 py-10">
        <div className="border border-blue-400 container flex items-center h-14 max-lg:px-5">
            ...
            <button onClick={ () => setIsOpen(preState =>!preState)} className="lg:hidden z-2 size-10 border-2 border-s4/25 rounded-full flex justify-center items-center"> <img src={`/images/${isOpen ? "close" : "magic"}.svg`} className="size-1/2 object-contain"/> </button>
